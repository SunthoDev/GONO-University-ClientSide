    ...
    return (
        <div className="drawer md:drawer-open  bg-[#F6F6F6] ">
            ...
            <div className="drawer-side fixed">
                ...
                <ul className="menuParent menu px-6 pt-[28px] w-90 text-base-content h-[100vh]">
                    ...
                    <>
                        <li className='Dashboard'> <Link to="/dashboard/AdminHome"> Dashboard</Link></li>
                        <li> <NavLink to="/dashboard/AddStudentInformation"><span><FaWallet></FaWallet></span>Add Student Info</NavLink></li>
                        <li> <NavLink to="/dashboard/SeeAllStudentInformation"><span><FaWallet></FaWallet></span> Student Info All</NavLink></li>
                        <li> <NavLink to="/dashboard/AdminSeeAllUser"><span><FaWallet></FaWallet></span> All User</NavLink></li>
                    </>
