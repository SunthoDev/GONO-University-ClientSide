...
const AdminHome = () => {
    ...
    // ===========================================
    // User Entered all data find here
    // ===========================================
                        ...
                        <div class="bg-gradient-to-b from-green-200 to-green-100 border-b-4 border-green-600 rounded-lg shadow-xl p-5">
                            <div class="flex flex-row items-center">
                                ...
                                <div class="flex-1 text-right md:text-center">
                                    <h2 class="font-bold uppercase text-gray-600">Total Entry Data</h2>
                                    <p class="font-bold text-3xl">${UserEnterAllData?.length} <span class="text-green-500"> </span></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-b from-pink-200 to-pink-100 border-b-4 border-pink-500 rounded-lg shadow-xl p-5">
                            <div class="flex flex-row items-center">
                                ...
                                <div class="flex-1 text-right md:text-center">
                                    ...
                                    <p class="font-bold text-3xl">{adminAllUsers?.length} <span class="text-pink-500"><i class="fas fa-exchange-alt"></i></span></p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                        ...
                        <div class="bg-gradient-to-b from-yellow-200 to-yellow-100 border-b-4 border-yellow-600 rounded-lg shadow-xl p-5">
                            <div class="flex flex-row items-center">
                                ...
                                <div class="flex-1 text-right md:text-center">
                                    {/* <h2 class="font-bold uppercase text-gray-600">Single Purses Total</h2> */}
                                    <h2 class="font-bold uppercase text-gray-600">Any Issues</h2>
                                    <p class="font-bold text-3xl">0<span class="text-yellow-600"> </span></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-b from-blue-200 to-blue-100 border-b-4 border-blue-500 rounded-lg shadow-xl p-5">
                            <div class="flex flex-row items-center">
                                ...
                                <div class="flex-1 text-right md:text-center">
                                    ...
                                    <p class="font-bold text-3xl">0 days</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-b from-red-200 to-red-100 border-b-4 border-red-500 rounded-lg shadow-xl p-5">
                            <div class="flex flex-row items-center">
                                ...
                                <div class="flex-1 text-right md:text-center">
                                    ...
                                    <p class="font-bold text-3xl">0 <span class="text-red-500"> </span></p>
                                </div>
                            </div>
                        </div>
